...
function App() {
  ...
  const personalDetails = {
    name: "Mohammed EL HABACHI",
    location: "Casablanca, Morroco",
    email: "Habachi20000@gmail.com",
    brand: "Junior Full-Stack MERN developer, passionate about creating attractive and functional websites. I am constantly learning to evolve professionally in the field of computer science.",
  };
      ...
      {showLoader ? (
        ...
        <>
          ...
          <Routes location={location} key={location.pathname}>
            ...
            <Route path="/about-me" element={<AboutMe brand={personalDetails.name} />} />
