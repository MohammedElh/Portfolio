...
const SocialIcons = () => {
  ...
  return (
    <div className="socialIcons" style={styles.socialIcons}>
      <a className="icon" style={styles.icon} href="https://github.com/MohammedElh">
        {/* GitHub Icon */}
        <motion.i
      ...
      <a className="icon" style={styles.icon} href="https://www.linkedin.com/in/mohammed-el-habachi-a75428257/">
        {/* LinkedIn Icon */}
        <motion.i
      ...
      <a className="icon" style={styles.icon} href="https://www.instagram.com/mohv_mmed_/">
        {/* Instagram Icon */}
        <motion.i
          initial={{ y: 100, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
      ...
      <a className="icon" style={styles.icon} href="https://twitter.com/Mohammed_Elh0">
        {/* Twitter Icon */}
        <motion.i
          initial={{ y: 100, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
